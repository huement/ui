...
var Tab = /*#__PURE__*/function (_BaseComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function _activate(element, relatedElem) {
      ...
      this._activate(_selectorEngine["default"].getElementFromSelector(element)); // Search and activate/show the proper section
    ...
    value: function _deactivate(element, relatedElem) {
      ...
      element.blur();
      this._deactivate(_selectorEngine["default"].getElementFromSelector(element)); // Search and deactivate the shown section too
    ...
    value: function _keydown(event) {
      ...
      if ([HOME_KEY, END_KEY].includes(event.key)) {
        ...
        nextActiveElement = (0, _index.getNextActiveElement)(children, event.target, isNext, true);
      }
    ...
    value: function _setInitialAttributesOnTargetPanel(child) {
      var target = _selectorEngine["default"].getElementFromSelector(child);
      if (!target) {
        return;
      }
 ...
 */
_eventHandler["default"].on(window, EVENT_LOAD_DATA_API, function () {
  var _iterator2 = _createForOfIteratorHelper(_selectorEngine["default"].find(SELECTOR_DATA_TOGGLE_ACTIVE)),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var element = _step2.value;
...
var _templateFactory = _interopRequireDefault(require("./util/template-factory.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != _typeof(e) && "function" != typeof e) return { "default": e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && Object.prototype.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n["default"] = e, t && t.set(e, n), n; }
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
  ...
  _createClass(Tooltip, [{
    ...
    value: function _getTemplateFactory(content) {
      if (this._templateFactory) {
        ...
        this._templateFactory = new _templateFactory["default"](_objectSpread(_objectSpread({}, this._config), {}, {
    ...
    value: function _createPopper(tip) {
      var placement = (0, _index.execute)(this._config.placement, [this, tip, this._element]);
    ...
    value: function _resolvePossibleFunction(arg) {
      return (0, _index.execute)(arg, [this._element]);
    }
  }, {
    key: "_getPopperConfig",
...
var DefaultAllowlist = exports.DefaultAllowlist = {
  ...
  _createClass(TemplateFactory, [{
    ...
    value: function _setContent(template, content, selector) {
      ...
      if ((0, _index.isElement)(content)) {
        this._putElementInTemplate((0, _index.getElement)(content), templateElement);
        return;
      }
    ...
    value: function _maybeSanitize(arg) {
      return this._config.sanitize ? (0, _sanitizer.sanitizeHtml)(arg, this._config.allowList, this._config.sanitizeFn) : arg;
    }
  }, {
    key: "_resolvePossibleFunction",
    value: function _resolvePossibleFunction(arg) {
      return (0, _index.execute)(arg, [this]);
    }
  }, {

...
},{"./src/alert.js":2,"./src/button.js":4,"./src/collapse.js":5,"./src/dropdown.js":10,"./src/modal.js":11,"./src/offcanvas.js":12,"@popperjs/core/dist/umd/popper.js":20}],2:[function(require,module,exports){
"use strict";
...
},{"./base-component.js":3,"./dom/event-handler.js":7,"./util/component-functions.js":14,"./util/index.js":17}],3:[function(require,module,exports){
"use strict";
...
exports["default"] = void 0;
var _data = _interopRequireDefault(require("./dom/data.js"));
var _eventHandler = _interopRequireDefault(require("./dom/event-handler.js"));
...
},{"./dom/data.js":6,"./dom/event-handler.js":7,"./util/config.js":15,"./util/index.js":17}],4:[function(require,module,exports){
"use strict";
...
},{"./base-component.js":3,"./dom/event-handler.js":7,"./util/index.js":17}],5:[function(require,module,exports){
"use strict";
...
var Collapse = /*#__PURE__*/function (_BaseComponent) {
  ...
  function Collapse(element, config) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var selector = _selectorEngine["default"].getSelectorFromElement(elem);
        var filterElement = _selectorEngine["default"].find(selector).filter(function (foundElement) {
  ...
  _createClass(Collapse, [{
    ...
    value: function hide() {
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          var element = _selectorEngine["default"].getElementFromSelector(trigger);
    ...
    value: function _initializeChildren() {
      ...
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          ...
          var selected = _selectorEngine["default"].getElementFromSelector(element);
          if (selected) {
    ...
    value: function _getFirstLevelChildren(selector) {
      ...
      return _selectorEngine["default"].find(selector, this._config.parent).filter(function (element) {
...
_eventHandler["default"].on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
  ...
  var _iterator6 = _createForOfIteratorHelper(_selectorEngine["default"].getMultipleElementsFromSelector(this)),
    _step6;
  try {
...
},{"./base-component.js":3,"./dom/event-handler.js":7,"./dom/selector-engine.js":9,"./util/index.js":17}],6:[function(require,module,exports){
"use strict";
...
},{"../util/index.js":17}],8:[function(require,module,exports){
"use strict";
...
var getSelector = function getSelector(element) {
  ...
  if (!selector || selector === '#') {
    ...
    selector = hrefAttribute && hrefAttribute !== '#' ? (0, _index.parseSelector)(hrefAttribute.trim()) : null;
  }
  return selector;
};
var SelectorEngine = {
...
},{"../util/index.js":17}],10:[function(require,module,exports){
"use strict";
...
var Dropdown = /*#__PURE__*/function (_BaseComponent) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function _getPopperConfig() {
      ...
      return _objectSpread(_objectSpread({}, defaultBsPopperConfig), (0, _index.execute)(this._config.popperConfig, [defaultBsPopperConfig]));
    }
  }, {
    key: "_selectMenuItem",
...
},{"./base-component.js":3,"./dom/event-handler.js":7,"./dom/manipulator.js":8,"./dom/selector-engine.js":9,"./util/index.js":17,"@popperjs/core":19}],11:[function(require,module,exports){
"use strict";
...
var Modal = /*#__PURE__*/function (_BaseComponent) {
  ...
  _createClass(Modal, [{
    ...
    key: "dispose",
    value: function dispose() {
      _eventHandler["default"].off(window, EVENT_KEY);
      _eventHandler["default"].off(this._dialog, EVENT_KEY);
...
},{"./base-component.js":3,"./dom/event-handler.js":7,"./dom/selector-engine.js":9,"./util/backdrop.js":13,"./util/component-functions.js":14,"./util/focustrap.js":16,"./util/index.js":17,"./util/scrollbar.js":18}],12:[function(require,module,exports){
"use strict";
...
_eventHandler["default"].on(window, EVENT_LOAD_DATA_API, function () {
  var _iterator = _createForOfIteratorHelper(_selectorEngine["default"].find(OPEN_SELECTOR)),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
...
_eventHandler["default"].on(window, EVENT_RESIZE, function () {
  var _iterator2 = _createForOfIteratorHelper(_selectorEngine["default"].find('[aria-modal][class*=show][class*=offcanvas-]')),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var element = _step2.value;
...
},{"./base-component.js":3,"./dom/event-handler.js":7,"./dom/selector-engine.js":9,"./util/backdrop.js":13,"./util/component-functions.js":14,"./util/focustrap.js":16,"./util/index.js":17,"./util/scrollbar.js":18}],13:[function(require,module,exports){
"use strict";
...
},{"../dom/event-handler.js":7,"./config.js":15,"./index.js":17}],14:[function(require,module,exports){
"use strict";
...
var enableDismissTrigger = exports.enableDismissTrigger = function enableDismissTrigger(component) {
...
},{"../dom/event-handler.js":7,"../dom/selector-engine.js":9,"./index.js":17}],15:[function(require,module,exports){
"use strict";
...
var Config = /*#__PURE__*/function () {
  ...
  _createClass(Config, [{
    ...
    value: function _mergeConfigObj(config, element) {
      var jsonConfig = (0, _index.isElement)(element) ? _manipulator["default"].getDataAttribute(element, 'config') : {}; // try to parse

      return _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, this.constructor.Default), _typeof(jsonConfig) === 'object' ? jsonConfig : {}), (0, _index.isElement)(element) ? _manipulator["default"].getDataAttributes(element) : {}), _typeof(config) === 'object' ? config : {});
    }
  }, {
    ...
    value: function _typeCheckConfig(config) {
      ...
      for (var _i = 0, _Object$entries = Object.entries(configTypes); _i < _Object$entries.length; _i++) {
        ...
        var valueType = (0, _index.isElement)(value) ? 'element' : (0, _index.toType)(value);
...
},{"../dom/manipulator.js":8,"./index.js":17}],16:[function(require,module,exports){
"use strict";
...
},{"../dom/event-handler.js":7,"../dom/selector-engine.js":9,"./config.js":15}],17:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.triggerTransitionEnd = exports.toType = exports.reflow = exports.parseSelector = exports.onDOMContentLoaded = exports.noop = exports.isVisible = exports.isRTL = exports.isElement = exports.isDisabled = exports.getjQuery = exports.getUID = exports.getTransitionDurationFromElement = exports.getNextActiveElement = exports.getElement = exports.findShadowRoot = exports.executeAfterTransition = exports.execute = exports.defineJQueryPlugin = void 0;
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
 ...
 * @returns {string}
 */
var parseSelector = exports.parseSelector = function parseSelector(selector) {
...
var toType = exports.toType = function toType(object) {
...
var getUID = exports.getUID = function getUID(prefix) {
  do {
    prefix += Math.floor(Math.random() * MAX_UID);
  } while (document.getElementById(prefix));
  return prefix;
};
var getTransitionDurationFromElement = exports.getTransitionDurationFromElement = function getTransitionDurationFromElement(element) {
  if (!element) {
    return 0;
  }
...
var triggerTransitionEnd = exports.triggerTransitionEnd = function triggerTransitionEnd(element) {
  element.dispatchEvent(new Event(TRANSITION_END));
};
var isElement = exports.isElement = function isElement(object) {
...
var getElement = exports.getElement = function getElement(object) {
...
var isDisabled = exports.isDisabled = function isDisabled(element) {
...
var findShadowRoot = exports.findShadowRoot = function findShadowRoot(element) {
 ...
 */
var reflow = exports.reflow = function reflow(element) {
  element.offsetHeight; // eslint-disable-line no-unused-expressions
};
var getjQuery = exports.getjQuery = function getjQuery() {
...
var onDOMContentLoaded = exports.onDOMContentLoaded = function onDOMContentLoaded(callback) {
...
var defineJQueryPlugin = exports.defineJQueryPlugin = function defineJQueryPlugin(plugin) {
...
var execute = exports.execute = function execute(possibleCallback) {
  var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var defaultValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : possibleCallback;
  return typeof possibleCallback === 'function' ? possibleCallback.apply(void 0, _toConsumableArray(args)) : defaultValue;
};
var executeAfterTransition = exports.executeAfterTransition = function executeAfterTransition(callback, transitionElement) {
 ...
 */
var getNextActiveElement = exports.getNextActiveElement = function getNextActiveElement(list, activeElement, shouldGetNext, isCycleAllowed) {
...
var ScrollBarHelper = /*#__PURE__*/function () {
  ...
  _createClass(ScrollBarHelper, [{
    ...
    value: function _saveInitialAttribute(element, styleProperty) {
      ...
      if (actualValue) {
        _manipulator["default"].setDataAttribute(element, styleProperty, actualValue);
      }
    }
  }, {
    ...
    value: function _resetElementAttributes(selector, styleProperty) {
      var manipulationCallBack = function manipulationCallBack(element) {
        var value = _manipulator["default"].getDataAttribute(element, styleProperty);
        // We only want to remove the property if the value is `null`; the value can also be zero
        if (value === null) {
          element.style.removeProperty(styleProperty);
          return;
        }
        _manipulator["default"].removeDataAttribute(element, styleProperty);
    ...
    value: function _applyManipulationCallback(selector, callBack) {
      ...
      var _iterator = _createForOfIteratorHelper(_selectorEngine["default"].find(selector, this._element)),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var sel = _step.value;
...
},{"../dom/manipulator.js":8,"../dom/selector-engine.js":9,"./index.js":17}],19:[function(require,module,exports){
/**
